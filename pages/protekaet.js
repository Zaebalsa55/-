...
const Page = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      <p><strong>5. Обеспечьте прочную установку машины.</strong> Стираль��ая машина должна стоять строго по уровню: если она «гуляет», вибрации ускоряют износ деталей. Регулируйте ножки так, чтобы машина была неподвижна при работе.</p>
