              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Отк��ойте люк и закройте его заново до характерного щелчка. Иногда простое неплотное закрытие блокирует пуск. Проверьте, не мешают ли защёлке посторонние предм��ты или грязь.
                  </p>
                  ...
                  <p>
                    ...
                    Если машинка всё ещё не подаёт признаков жизни, осмотрите сетевой фильтр и впускной клапан. Для фильтра ��ужен мультиметр, для клапана — визуальны�� осмотр или звон мастеру. Часто эти детали меняют полностью.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Мозг с��иральной машины — это управляющая ��лата. Именно о��а хр��нит программы стирки и управляет всеми процессами. Если она выходит из строя, техника не запускается, индикат��ры не горят или в��дут себя странно. Иногда помогает простой сброс: отключите питание на 10–20 минут и попробуйте снова. Если не помогло — скорее всего, нужна прошивка, ремонт или замена модуля. Этим обычно занимается специалист.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как безоп��сно перевозить и хранить стиральную машину
                </span>
