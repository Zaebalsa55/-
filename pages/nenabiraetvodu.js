...
const Page = () => {
  ...
  const anchors = {
    ...
    items: [
      { icon: '/external/vector8669-r6fr.svg', href: '#1', text: 'Что делать, е��ли машина не набирает воду?' },
